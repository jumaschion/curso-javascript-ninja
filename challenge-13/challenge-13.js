...
var sudeste = ['Sao Paulo', 'Minas Gerais', ' Rio de janeiro' ]
/*
...
var maisDeSeteLetras = brasil.every(item =>  {
    return item.length > 7
  })
  
  console.log("Mais de 7 letras", maisDeSeteLetras ? "Sim, todos os estados tem mais de sete letras" : "Nem todos os estados tem mais de sete letras")
// ?
